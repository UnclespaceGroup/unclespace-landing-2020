...
import css from './SectionContactsDesktop.module.scss'
...
const SectionContactsDesktop = ({ title, text, items, mapCoords }) => (
...
export default React.memo(SectionContactsDesktop)
